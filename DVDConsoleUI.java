...
public class DVDConsoleUI implements DVDUserInterface {
	...
	private void doAddOrModifyDVD() {
		...
		if (title.equals("")) return;		// input was cancelled
		title = title.toUpperCase();
		
		// Request the rating
		System.out.println("Enter rating");
		String rating = scan.nextLine();
		if (rating.equals("")) return;		// input was cancelled
		...
		if (time.equals("")) return;	// input was cancelled
	...
	private void doRemoveDVD() {
		...
		System.out.println("Enter title");
		String title = scan.nextLine();
		if (title.equals("")) return;		// dialog was cancelled
		title = title.toUpperCase();
	...
	private void doGetDVDsByRating() {
		...
		System.out.println("Enter rating");
		String rating = scan.nextLine();
		if (rating.equals("")) return;		// dialog was cancelled
		rating = rating.toUpperCase();
